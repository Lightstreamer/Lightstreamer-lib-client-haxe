...
public:
   ...
   * through {@link LightstreamerClient#removeListener()}. This is the last event to be fired on the listener.
   */
   ...
   * through {@link LightstreamerClient#addListener()}. This is the first event to be fired on the listener.
   */
   ...
   *   <li>Depending on the setting in {@link ConnectionOptions#setSlowingEnabled()}, in case of slow update processing, 
   ...
   *   <li>In case a forced transport was set through {@link ConnectionOptions#setForcedTransport()}, only the 
