...
public:
   ...
   * 
   * @return the adapterSet the name of the Adapter Set; returns an empty string if no name has been configured, that 
   ...
   * 
   * @param adapterSet The name of the Adapter Set to be used. An empty string is equivalent to the "DEFAULT" name.
   */
   ...
   * ClientListener listening to the related LightstreamerClient.
   * 
   * @param serverAddress The full address of Lightstreamer Server. An empty string can also be used, to restore the default value. 
   ...
   * 
   * @throws LightstreamerError if the given address is not valid.
   */
   ...
   * 
   * @return the username to be used for the authentication on Lightstreamer Server; returns an empty string if no 
   ...
   * ClientListener listening to the related LightstreamerClient.
   * 
   * @param user The username to be used for the authentication on Lightstreamer Server. The username can be an empty string.
   * 
   * @see #setPassword()
   */
   ...
   * available at /dashboard).
   * 
   * @lifecycle If a session is not currently active, an empty string is returned;
   ...
   * ClientListener listening to the related LightstreamerClient.
   * 
   * @return address used to issue all requests related to the current session, or an empty string.
   */
   ...
   * ClientListener listening to the related LightstreamerClient.
   * 
   * @return name configured for the Server instance which is managing the current session, or an empty string.
   */
   ...
   * ClientListener listening to the related LightstreamerClient.
   * 
   * @return  A canonical representation of an IP address (it can be either IPv4 or IPv6), or an empty string.
   */
   ...
   * ClientListener listening to the related LightstreamerClient.
   * 
   * @return ID assigned by the Server to this client session, or an empty string.
   */
   ...
   * The Metadata Adapter, however, may still allow the session.
   * 
   * @lifecycle The password should be set on the {@link LightstreamerClient#connectionDetails} object before calling 
