...
|||
|---|---|
|**Web**|[Get the lib](https://www.npmjs.com/package/lightstreamer-client-web/v/9.1.1)<br>[Changelog](CHANGELOG-Web.md)<br>[Quickstart](https://sdk.lightstreamer.com/ls-web-client/9.1.1/api/index.html#quickstart)<br>[API Reference](https://sdk.lightstreamer.com/ls-web-client/9.1.1/api/index.html)<br>[Building](#web)|
...
|**Android**|[Get the lib](https://central.sonatype.com/artifact/com.lightstreamer/ls-android-client/5.1.1)<br>[Changelog](CHANGELOG-Android.md)<br>[Quickstart](https://sdk.lightstreamer.com/ls-android-client/5.1.1/api/index.html#quickstart)<br>[API Reference](https://sdk.lightstreamer.com/ls-android-client/5.1.1/api/index.html)<br>[Building](#android)|
