...
class ConnectionDetails {
   ...
   * 
   * @see `this.setAdapterSet`
   */
  public function getAdapterSet(): Null<String> return null;
  /**
   ...
   */
  public function getServerAddress(): Null<String> return null;
/**
   ...
   */
  public function getUser(): Null<String> return null;
/**
 ...
 /**
   ...
   */
  public function getSessionId(): Null<String> return null;
/**
   * Inquiry method that gets the server address to be used to issue all requests related to the current session. 
   * In fact, when a Server cluster is in place, the Server address specified through `this.setServerAddress` can 
   ...
   */
  public function getServerInstanceAddress(): Null<String> return null;
/**
   ...
   */
  public function getServerSocketName(): Null<String> return null;
  /**
   ...
   */
  public function getClientIp(): Null<String> return null;
}