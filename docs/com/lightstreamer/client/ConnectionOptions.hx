...
class ConnectionOptions {
   ...
   * reconnection fail, only the setting of `this.setRetryDelay` will be applied.
   * 
   ...
   * @see `this.setForcedTransport(String)`
   */
  public function getForcedTransport(): Null<String> return null;
  /**
   ...
   * @see `this.setRequestedMaxBandwidth(String)`
   */
  public function getRequestedMaxBandwidth(): String return null;
  /**
   ...
   * maximum bandwidth, returned by `this.getRequestedMaxBandwidth()`. <BR>
   ...
   * by a call to `ClientListener.onPropertyChange` with argument "realMaxBandwidth".
   * 
   ...
   * @see `this.setRequestedMaxBandwidth(String)`
   */
  public function getRealMaxBandwidth(): Null<String> return null;
  /**
 ...
 /**
   ...
   * polling mode can be forced by calling `this.setForcedTransport` with "WS-POLLING" or "HTTP-POLLING" 
   * as parameter. <BR>
   ...
   * @throws IllegalArgumentException if a negative or zero value is configured 
   * 
   * @see `this.setFirstRetryMaxDelay`
   * @see `this.getCurrentConnectTimeout`
   */
   ...
   * upon each streaming request. For long polling, the `this.setIdleTimeout` setting
   ...
   * whereas, for long polling, the `this.setIdleTimeout` setting has a similar function.</li>
   * </ul>
   * 
   ...
   * `ConnectionDetails.setServerAddress(String)` can identify various Server instances; in order to 
   ...
   * 
   * **notification** A change to this setting will be notified through a call to 
   * `ClientListener.onPropertyChange` with argument "proxy" on any 
   * ClientListener listening to the related LightstreamerClient.
   * 
