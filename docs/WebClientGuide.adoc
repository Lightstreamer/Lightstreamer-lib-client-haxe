...
The suggested approach is to use a https://lightstreamer.com/api/ls-web-client/latest/ConsoleLoggerAppender.html[ConsoleLoggerAppender] configured at INFO
