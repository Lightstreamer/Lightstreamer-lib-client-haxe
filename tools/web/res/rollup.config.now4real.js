...
import pkg from '../../../bin/web/build/dist/now4real/package.json'
import classes from '../../../src/wrapper/web/core/wrapper.export.json';

const dist = 'bin/web/build/dist/now4real'
const [versionNum, buildNum] = JsUtils.parseSemVer(pkg.version)

export default [
  {
    input: 'bin/web/build/now4real/obj/ls_web_client_wrapper.js',
    output: [ 
      {
