...
function main() {
  ...
  println("
To upload the package on Test PyPi, run the following commands (from the folder 'dist/pythlightstreamer-client'):
$ python3 -m build
$ twine upload -r testpypi dist/*

To upload the package on PyPi, run the following commands (from the folder 'dist/pythlightstreamer-client'):
$ python3 -m build
$ twine upload dist/*
